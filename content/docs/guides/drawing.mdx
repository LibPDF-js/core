...
| ------- | ------------------- | --------------------- |
| M/m     | Move to             | `M 10 20`             |
| L/l     | Line to             | `L 100 200`           |
| H/h     | Horizontal line     | `H 150`               |
| V/v     | Vertical line       | `V 100`               |
| C/c     | Cubic bezier        | `C 10 20 30 40 50 60` |
| S/s     | Smooth cubic        | `S 30 40 50 60`       |
| Q/q     | Quadratic bezier    | `Q 50 100 100 0`      |
| T/t     | Smooth quadratic    | `T 150 0`             |
| A/a     | Elliptical arc      | `A 50 50 0 0 1 100 0` |
| Z/z     | Close path          | `Z`                   |
...
| `borderWidth` | `number`       | Stroke width in points                   |
