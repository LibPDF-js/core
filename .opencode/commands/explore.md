...
1. **Understand the request** - What feature or topic is `$ARGUMENTS` asking about?
...
Search the reference libraries for `$ARGUMENTS` and compile your research findings.
