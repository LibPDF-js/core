...
import { SVGRenderer, createSVGRenderer, LineCap, LineJoin, TextRenderMode } from "./svg-renderer";
...
describe("SVGRenderer", () => {
  ...
  describe("initialization", () => {
    ...
    it("returns null SVG in headless mode", () => {
  ...
  describe("path painting operations", () => {
    it("strokes path in headless mode", () => {
      renderer.moveTo(0, 0);
      renderer.lineTo(100, 100);
      renderer.stroke();
      // No errors in headless mode
    ...
    it("fills path in headless mode", () => {
      renderer.rectangle(10, 20, 100, 50);
      renderer.fill();
      // No errors in headless mode
    });

    it("fills even-odd in headless mode", () => {
      renderer.rectangle(10, 20, 100, 50);
      renderer.fillEvenOdd();
      // No errors in headless mode
    });

    it("fills and strokes in headless mode", () => {
      renderer.rectangle(10, 20, 100, 50);
      renderer.fillAndStroke();
      // No errors in headless mode
    });

    it("close and stroke in headless mode", () => {
      renderer.moveTo(0, 0);
      renderer.lineTo(100, 0);
  ...
  describe("clipping operations", () => {
    it("clips in headless mode", () => {
      renderer.rectangle(10, 20, 100, 50);
      renderer.clip();
      // No errors in headless mode
    });

    it("clips even-odd in headless mode", () => {
      renderer.rectangle(10, 20, 100, 50);
...
describe("SVGRenderer LineCap constants", () => {
...
describe("SVGRenderer LineJoin constants", () => {
  it("has correct values", () => {
...
describe("SVGRenderer TextRenderMode constants", () => {
  it("has correct values", () => {
...
describe("SVGRenderer coordinate transformation", () => {
  let renderer: SVGRenderer;
...
describe("SVGRenderer vs CanvasRenderer parity", () => {
  it("has the same renderer type property", () => {
    const renderer = new SVGRenderer();
    expect(renderer.type).toBe("svg");
  });

  it("implements the BaseRenderer interface", async () => {
    const renderer = new SVGRenderer();

    // Check all required methods exist
    expect(typeof renderer.initialize).toBe("function");
    expect(typeof renderer.createViewport).toBe("function");
    expect(typeof renderer.render).toBe("function");
    expect(typeof renderer.destroy).toBe("function");

    // Check required properties
    expect(typeof renderer.initialized).toBe("boolean");
    expect(typeof renderer.type).toBe("string");
  });

  it("has matching graphics state management methods", async () => {
    const renderer = new SVGRenderer();
    await renderer.initialize({ headless: true });

    // Check graphics state methods
    expect(typeof renderer.pushGraphicsState).toBe("function");
    expect(typeof renderer.popGraphicsState).toBe("function");
    expect(typeof renderer.resetGraphicsState).toBe("function");

    // Check line property methods
    expect(typeof renderer.setLineWidth).toBe("function");
    expect(typeof renderer.setLineCap).toBe("function");
    expect(typeof renderer.setLineJoin).toBe("function");
    expect(typeof renderer.setMiterLimit).toBe("function");
    expect(typeof renderer.setDashPattern).toBe("function");

    // Check color methods
    expect(typeof renderer.setStrokingGray).toBe("function");
    expect(typeof renderer.setNonStrokingGray).toBe("function");
    expect(typeof renderer.setStrokingRGB).toBe("function");
    expect(typeof renderer.setNonStrokingRGB).toBe("function");
    expect(typeof renderer.setStrokingCMYK).toBe("function");
    expect(typeof renderer.setNonStrokingCMYK).toBe("function");

    // Check text methods
    expect(typeof renderer.setFont).toBe("function");
    expect(typeof renderer.setCharSpacing).toBe("function");
    expect(typeof renderer.setWordSpacing).toBe("function");
    expect(typeof renderer.beginText).toBe("function");
    expect(typeof renderer.endText).toBe("function");
    expect(typeof renderer.showText).toBe("function");

    // Check path methods
    expect(typeof renderer.moveTo).toBe("function");
    expect(typeof renderer.lineTo).toBe("function");
    expect(typeof renderer.curveTo).toBe("function");
    expect(typeof renderer.closePath).toBe("function");
    expect(typeof renderer.stroke).toBe("function");
    expect(typeof renderer.fill).toBe("function");

    // Check operator execution
    expect(typeof renderer.executeOperator).toBe("function");
    expect(typeof renderer.executeOperators).toBe("function");
  });
});
